...
/// [StateNotifierProvider] managing an active reading session.
///
/// Provides a real-time timer and page tracking for an ongoing reading session.
/// When the session ends, the data is persisted to the database.
class ActiveSessionNotifier extends StateNotifier<ActiveSessionState> {
  ...
  void endSession({int? endPage}) {
    ...
    if (state.bookId != null) {
      _ref.invalidate(bookSessionsProvider(state.bookId!));
    }
